...
<body>
  ...
  <section class="vh-100" style="background:grey;">
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col">
          <?php
          $stmt2 = $admin->ret("SELECT * FROM `order1` INNER JOIN `product` ON order1.pid=product.pid WHERE order1.cusid='$cid' ORDER BY order1.oid DESC");
          $c=$stmt2->rowCount();
            ...
            <div class="card card-stepper mt-2" style="border-radius: 10px;">
              ...
              <div class="card-body p-4">
                ...
                // $row4 = $stmt4->fetch(PDO::FETCH_ASSOC);
                  ...
                  ?>
                    <div class="d-flex flex-column">
                      ...
                      <span class="text">Quantity: <?php echo $row['or_quantity'] ?> x <?php echo $row['product_price'] ?> = <?php echo $total ?></span>
                    </div>
                 
                  <div>
                    <?php if ($b_status == 'order_accepted') { ?>
                     <a type="button" style="background-color:green;" class="btn btn-success" class="btn btn-danger  btn-fw" href="./controller/update_status.php?order_cancel=<?php echo $row['unid'] ?>&r_id=<?php echo $row['cusid'] ?>">Cancel order</a>


                    <?php }elseif($b_status == 'order_canceled'){ ?>

                     <button style="background-color: red;" class="btn btn-success">Order Canceled</button>
                ...
                <div class="d-flex flex-row justify-content-between align-items-center">
                  <div class="d-flex flex-column align-items-start"><span>Order Accepted </span></div>
